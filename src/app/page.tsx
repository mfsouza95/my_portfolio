      ...
      <section className="min-h-screen flex items-center justify-center relative overflow-hidden pt-16">
        ...
        <div className="max-w-6xl mx-auto px-4 w-full relative z-10">
          ...
          <div className="flex flex-wrap justify-center gap-4 pt-8">
            ...
            <a className="inline-flex items-center gap-2 font-mono text-xs uppercase tracking-wider px-5 py-2.5 rounded-md border border-teal-500/30 bg-teal-500/5 text-teal-400 hover:border-teal-400 hover:bg-teal-500/10 transition-all shadow-md group" href="">
