export const projectsData = [
  {
    id: "creeper-tools",
    title: "Creeper Tools",
    description: "Uma aplicação web criado para ser uma coletânea de ferramentas, facilitadoras para assíduos jogadores de Minecraft",
  ...
  },
  {
    ...
    description: "Criado para ser uma imitação do sistema de busca do Google, consumindo a API publica do PokeAPI e sugerir respostas",
...
export const productsData = [
  {
    ...
    title: "CV",
    price: 0,
    fileUrl: "/docs/curriculo_murilo.pdf"
  }
];
